...
{
    if(
       (tile[index[0]][3]==tile[index[1]][1])&&
       (tile[index[0]][2]==tile[index[3]][0])&&
       (tile[index[1]][3]==tile[index[2]][1])&&
       (tile[index[1]][2]==tile[index[4]][0])&&
       (tile[index[2]][2]==tile[index[5]][0])&&
       (tile[index[3]][3]==tile[index[4]][1])&&
       (tile[index[3]][2]==tile[index[6]][0])&&
       (tile[index[4]][3]==tile[index[5]][1])&&
       (tile[index[4]][2]==tile[index[7]][0])&&
       (tile[index[5]][2]==tile[index[8]][0])&&
       (tile[index[6]][3]==tile[index[7]][1])&&
       (tile[index[7]][3]==tile[index[8]][1])
       ) return 1;
    else return 0;
